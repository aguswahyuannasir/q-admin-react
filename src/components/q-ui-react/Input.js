...
export default class Input extends Component{
  ...
  render(){
    ...
    let {as:As, label, elClass, inline, inputRef, inputClass, labelClass, 
				 type, id, invalid, valid, error, errType, grow, ...attr} = this.props;// isize
    ...
    return (
			<div className={
				...
				<label className={inline ? 'd-inline-block' : undefined + labelClass ? labelClass : undefined} htmlFor={id ? id : undefined}>
					<As
						ref={inputRef}
