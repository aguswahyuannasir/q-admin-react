...
import ResponsiveHelper from '../../../helpers/responsive';// 'helpers/responsive'
...
export default class DropDown extends React.Component{
  ...
  registerClickEvent = (e) => {
    ...
    if(this.dropDownContentElement.contains(e.target) || this.dropDownHandlerElement.contains(e.target)){
      return false
    }
