...
import getEditorControls from '../../../configs/controls';// 'configs/controls'
import LinkEditor from '../LinkEditor';// 'components/business/LinkEditor'
import HeadingPicker from '../Headings';// 'components/business/Headings'
import TextColorPicker from '../TextColor';// 'components/business/TextColor'
import FontSizePicker from '../FontSize';// 'components/business/FontSize'
import LineHeightPicker from '../LineHeight';// 'components/business/LineHeight'
import FontFamilyPicker from '../FontFamily';// 'components/business/FontFamily'
import TextAlign from '../TextAlign';// 'components/business/TextAlign'
import EmojiPicker from '../EmojiPicker';// 'components/business/EmojiPicker'
import LetterSpacingPicker from '../LetterSpacing';// 'components/business/LetterSpacing'
import TextIndent from '../TextIndent';// 'components/business/TextIndent'
import DropDown from '../../common/DropDown';// 'components/common/DropDown'
import {ContentUtils} from 'braft-utils';
import {showModal} from '../../common/Modal';// 'components/common/Modal'
import {getExtensionControls} from '../../../helpers/extension';// 'helpers/extension'
...
export default class ControlBar extends React.Component{
  ...
  render(){
    const {editor, editorId, editorState, className, style, controls, media, extendControls, language, hooks,
          colors, colorPicker, colorPickerTheme, colorPickerAutoHide, headings, fontSizes, fontFamilies, emojis,
          getContainerNode, lineHeights, letterSpacings, textAligns, textBackgroundColor, defaultLinkTarget} = this.props;
