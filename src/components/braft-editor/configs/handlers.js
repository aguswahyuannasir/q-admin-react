...
export const keyCommandHandlers = (command, editorState, editor) => { // (command, editorState, editor)
  ...
  if(command === 'tab'){
    ...
    if(blockType === 'code-block'){
      ...
      const newEditorState = RichUtils.onTab(editorState, 4,);// RichUtils.onTab(event, editorState, 4,)
