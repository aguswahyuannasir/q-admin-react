...
import {UncontrolledButtonDropdown, DropdownToggle, DropdownMenu, DropdownItem,// Progress,Badge,
        CardBody, CardHeader, CardFooter} from 'reactstrap';// Card,CardBody,CardHeader,CardFooter,Modal,ModalHeader,ModalBody,ModalFooter
...
export default class Qfile extends Component{
  constructor(props){
    ...
    bindMethods.call(this,[
      ...
      'showOptionInput','stopPro','onShot','clickShot',
    ]);
  }
...
// Q-CUSTOM handle screenshot
  ...
  render(){
    const {files, modal, imgModal, guideModal,
          cropResult, cropState, cameraOpen} = this.state;// imgEditIndex, tagModal, imgTag
    const {label, id, accept, required, responsive, ratio, zoom, guide, progressItem} = this.props;

    // form-group
    return (
      <div className="card p-3 Qfile">
        ...
        >
          {({getRootProps, getInputProps, isDragActive, isDragAccept, isDragReject}) => {
            return (
              ...
              >
                <input id={id} {...getInputProps()} required={required} capture />
                ...
                <div className="btn-group btn-group-app bg-white mt-5" onClick={this.stopPro}>
                  ...
                  <Btn onClick={() => this.showOptionInput("inputUrl")} outline className="i q-link-variant scale12">Link</Btn>
          ...
          >
            <Fragment>
              ...
              <CardFooter className="text-center">
                <Btn outline onClick={() => this.showOptionInput("inputUrl")}>Cancel</Btn>{' '}
