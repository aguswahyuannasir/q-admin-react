...
export default class Modal extends React.Component{
  ...
  renderComponent (props) {
    ...
    let {title, className, width, height, children, component, confirmable, showFooter, showCancel, showConfirm, showClose, 
					cancelText, confirmText, bottomText, language} = props
