...
// import '../assets/scss/_base.scss';// 'assets/scss/_base.scss'
...
import defaultProps from '../configs/props';// 'configs/props'
import {keyCommandHandlers, returnHandlers, beforeInputHandlers, dropHandlers, droppedFilesHandlers, copyHandlers, pastedFilesHandlers,
        pastedTextHandlers, compositionStartHandler} from '../configs/handlers';// 'configs/handlers'

import {getBlockRendererFn, getBlockRenderMap, getBlockStyleFn, getCustomStyleMap,
        getCustomStyleFn, getDecorators} from '../renderers';// 'renderers'

import {compositeStyleImportFn, compositeStyleExportFn, compositeEntityImportFn, compositeEntityExportFn, compositeBlockImportFn,
        compositeBlockExportFn, getPropInterceptors} from '../helpers/extension';// 'helpers/extension'
...
export default class BraftEditor extends React.Component{
  ...
  onTab = (e) => {
    ...
    this.editorProps.onTab && this.editorProps.onTab(e)
  }
  ...
  handleReturn = (e, editorState) => returnHandlers(e, editorState, this)
  ...
  handleCopyContent = (e) => copyHandlers(e, this)

  handlePastedText = (text, html, editorState) => pastedTextHandlers(text, html, editorState, this)

  handleCompositionStart = (e) => compositionStartHandler(e, this)
