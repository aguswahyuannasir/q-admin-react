...
// todo
// 禁止选中多个单元格式时进行输入和粘贴操作 - Jangan izinkan operasi input dan tempel ketika banyak format sel dipilih
// 可以按tab/shift + tab键切换选中单元格 - Anda dapat mengganti sel yang dipilih dengan menekan tab / shift + tab
// 可以按方向键切换选中表格 - Anda dapat menekan tombol panah untuk mengganti tabel yang dipilih.
// 在最后一个单元格中按Shift + 回车跳出表格 - Tekan Shift + Enter di sel terakhir untuk melompat keluar dari formulir
